...
#     subnetwork = module.landing-vpc.subnet_self_links["us-central1/landing-default-uc1"]
#     alias_ips  = {}
#     nat        = false
#     addresses  = null
#   }]
...
#     subnetwork = module.dev-spoke-vpc.subnet_self_links["us-central1/dev-default-uc1"]
#     alias_ips  = {}
#     nat        = false
#     addresses  = null
#   }]
...
#     # change the subnet name to match the values you are actually using
#     subnetwork = module.prod-spoke-vpc.subnet_self_links["us-central1/prod-default-uc1"]
#     alias_ips  = {}
#     nat        = false
#     addresses  = null
#   }]
